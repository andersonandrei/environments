...
## Export commands      
export PATH=~/.local/bin/kubectl/:/home/adasilva/.local/bin/:/home/adasilva/terraform/:/usr/local/bin:/usr/bin:/bin:/grid5000/code/bin:/opt/puppetlabs/bin
#export PATH=~/.local/bin/:/home/adasilva/.local/bin/:/home/adasilva/terraform/:/usr/local/bin:/usr/bin:/bin:/grid5000/code/bin:/opt/puppetlabs/bin
export PATH=~/.local/bin/kubectl/:$PATH
#export PATH=~/openwhisk_env/wskdeploy/:$PATH
#export PATH=~/openwhisk_env/wsk_cli/:$PATH
export PATH=~/terraform/:$PATH
#export PATH=~/.local/bin/:$PATH                                                                                                                                       

export KUBECONFIG=/home/adasilva/terraform/terraform-provider-grid5000/examples/kubernetes/kube_config_cluster.yml
#export KUBECONFIG=${PWD}/kube_config_cluster.yml
#export WSK_CONFIG_FILE=/home/adasilva/terraform/terraform-provider-grid5000/examples/kubernetes/kube_config_cluster.yml
export PATH=~/openfaas_env/:/home/adasilva/terraform/:/home/adasilva/.local/bin/kubectl/:/home/adasilva/.local/bin/:/usr/local/bin:/usr/bin:/bin:/grid5000/code/bin:/opt/puppetlabs/bin

export OPENFAAS_URL="http://127.0.0.1:8080"
if [ -e /home/adasilva/.nix-profile/etc/profile.d/nix.sh ]; then . /home/adasilva/.nix-profile/etc/profile.d/nix.sh; fi # added by Nix installer
